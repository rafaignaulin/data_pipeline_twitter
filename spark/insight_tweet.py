...
if __name__ == "__main__":
    ...
    tweet = spark.read.json("/home/rafael_ignaulin/Desktop/ALURA/datapipeline/datalake/silver/twitter_aluraonline/tweet")
    ...
    tweet.coalesce(1)\
        .write\
        .mode("overwrite")\
        .json("/home/rafael_ignaulin/Desktop/ALURA/datapipeline/datalake/gold/twitter_insight_tweet")